     ...
     <div class="type_title">支付方式</div>
      <div class="defray_content clearfix">
       ...
       <li class="defray_name">怡宝支付</li>
        ...
        <li class="operating">
        <a href="javascript:ovid()" class="btn btn-danger"><i class="fa fa-trash"></i>&nbsp;删除</a>
       <!-- <a href="javascript:ovid()" name="Payment_details.jsp" title="怡宝支付详细" onclick="Paymentdetails('234')" class="btn btn-success details_btn"><i class="fa  fa-newspaper-o "></i>&nbsp;详细</a>-->
        </li>
       </ul>
      </div>
    </div>
