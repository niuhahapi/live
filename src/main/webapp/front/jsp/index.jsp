...
<body>
	...
	<div class="box">
		<div class="demo">
			<p style="margin-top:15px;margin-left:-800px;">欢迎来到王者直播！</p>
			<nav class="main_nav">
			<ul>
				<li><input type="text" name="name" style="width:200px;height:25px;text-align:center;margin-top:-3px;margin-left:-400px;line-height:10px;border-radius:10px" /></li>
				<li style="margin-top:-3px;margin-left:-270px;text-align:center;font-size:17px;">搜索</li>
				<li style="width:150px;margin-top:-3px;margin-left:-10px;text-align:center;font-size:15px;"><a href="javascript:;" class="rollIn">登录/注册</a></li>
				<!-- <li style="margin-top:-3px;margin-left:-10px;text-align:center;font-size:17px;"><a href="javascript:;" class="rollIn">注册</a></li> -->
			</ul>
			</nav>
		</div>
		<div id="dialogBg"></div>
